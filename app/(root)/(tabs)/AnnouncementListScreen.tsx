    ...
    <LinearGradient colors={["#112D4E", "#8199B6"]} className="flex-1">
      <SafeAreaView className="flex-1 mt-10">
        <ScrollView contentContainerStyle={{ paddingBottom: 100 }} className="px-5">
          {/* Header */}
          <View className="mb-6">
            <AppText className="text-white text-2xl font-bold text-center my-6 tracking-wider">📋 Announcements</AppText>
            <AppText className="text-gray-200 mt-1 text-sm text-center">Hello, {user?.name || "User"}!</AppText>
          </View>
          ...
          {loading ? (
            ...
            <AppText className="text-white text-center mt-10">No announcements available</AppText>
          ) : (
