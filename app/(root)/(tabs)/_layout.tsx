    ...
    >
        ...
        options={{
          tabBarIcon: () => (
            <View className="items-center">
              ...
              <Text className="font-robotoSlabLight text-[#112D4E] text-xs">Info</Text>
            </View>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: () => (
            <View className="items-center">
              <Ionicons name="cash-outline" size={24} color="#112D4E" />
              <Text className="font-robotoSlabLight text-[#112D4E] text-xs">Payment</Text>
            </View>
          ),
        }}
      />
