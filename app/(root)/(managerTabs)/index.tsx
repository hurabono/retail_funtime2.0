        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, paddingHorizontal: 20, paddingBottom: 100 }}>
          ...
          <View className="flex-row justify-between items-center mt-5">
            <View>
              ...
              <Text className="text-white text-xl font-bold mt-1 mb-2 font-robotoSlabLight">
            ...
            <View className="flex-row justify-between">
              ...
              <View>
                <View className="flex-row justify-between items-center mb-2" >
                  <AppText className="bg-[#112D4E] text-white px-2 py-1 font-robotoSlabLight rounded-full w-[140px]">
                     {formattedDate}
                  </AppText>
                ...
                <View className="mt-2">
                  <AppText className="text-[#112D4E] font-semibold ml-2">{weekNumber}</AppText>
                  <TouchableOpacity className="bg-[#3F72AF] py-2 px-0 rounded-full mt-2">
                    <Link className="inline-block flex items-center justify-center" href="/AnnouncementManagerScreen">
                      <AppText className="text-white font-robotoSlabLight items-end text-center text-sm">Announcement</AppText>
                    </Link>
                  </TouchableOpacity>
                </View>
              </View>
                ...
                <View className="w-full mt-2">
                  ...
                  <TouchableOpacity className="bg-[#3F72AF] py-2 px-0 rounded-full mt-2">
                    <Link className="inline-block flex items-center justify-center" href="/_WorkingHours">
                      <AppText className="text-white font-robotoSlabLight items-end text-center text-sm">{isClockedIn ? 'Clock Out' : 'Clock In'}</AppText>
                    </Link>
                  </TouchableOpacity>
                </View>
              </View>
          ...
          <View className="bg-white px-3 py-5 mt-6 rounded-xl shadow-lg border-4 border-[#3F72AF]">
            <View className="flex-row justify-between items-center">
              <TouchableOpacity className="items-center" >
                ...
                <AppText className="text-[#3F72AF]  font-semibold text-xs">Team Members</AppText>
                  <AppText className="text-[#3F72AF]  font-semibold text-base">Time Logs</AppText>
                </Link>
              </TouchableOpacity>
              ...
              <TouchableOpacity className="items-center">
                ...
                <AppText className="text-[#3F72AF]  font-semibold text-xs mt-2">Team Members</AppText>
